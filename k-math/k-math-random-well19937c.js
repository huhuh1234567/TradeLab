(function(){
	...
	merge(Well19937cRandom.prototype,{
		___next: function(bits){
			...
			var indexRm1 = this.___iRm1[this.___index];
			var indexRm2 = this.___iRm2[this.___index];
	
			var v0       = this.___v[this.___index];
			var vM1      = this.___v[this.___i1[this.___index]];
			var vM2      = this.___v[this.___i2[this.___index]];
			var vM3      = this.___v[this.___i3[this.___index]];
